...
function merge() {
    var code = fs.readFileSync(__dirname + '/build/wrap/start.js', 'utf-8')
        ...
        + fs.readFileSync(__dirname + '/output/asset/Dance.js', 'utf-8')
    ...
    fs.writeFileSync(__dirname + '/dist/dance-' + package.version + '.min.js', minified.code);
    fs.writeFileSync(__dirname + '/dist/dance.latest.min.js', minified.code);
}
